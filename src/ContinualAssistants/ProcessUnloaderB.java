...
//meta! id="71"
public class ProcessUnloaderB extends Process {

    private Vehicle actualVehicle = null;
    private Vehicle lastVehicle = null;

    public ProcessUnloaderB(int id, Simulation mySim, CommonAgent myAgent) {
    ...
    public void processStart(MessageForm message) {
        ...
        if (SimulationConstants.TURN_ON_POSSITION_NOTES) {
            System.out.println(actualVehicle.getName() + "- vykladac B v case " + mySim().currentTime());
        }

        int resources = ((VehicleMessage) message).getResources();
        double timeOfAction = resources / SimulationConstants.UNLOAD_MACHINE2_SPEED;
        ...
        ((MySimulation) mySim()).getStats().getPointBUsage().addSampleB(timeOfAction);
